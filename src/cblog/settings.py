...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cjj61sd0s8zh.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesforza1blog' # please enter your s3 bucket name
